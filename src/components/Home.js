                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-6 text-center">
                                ...
                                <ul className='p-0'>
                                    <li>
                                        <h5 className='m-0 option-link'>ZUR APOTHEKE</h5>
                                    </li>
                                    <li>
                                        <h5 className='m-0 option-link'>ZUR PRAXIS</h5>
                                    </li>
                                </ul>
                            </div>
                            <div className="col-lg-6">
                                <div className="d-flex banner-item">
                                    <div className="round round-1 me-4">TERMIN FÜR DIE APOTHEKE BUCHEN</div>
                    ...
                    <div className="row justify-content-between">
                        <div className="col-lg-7 ps-0">
                            <div className="row align-items-center">
                                ...
                                <div className="col-8">
                                    <div className="heart-inner-content1">
                                        ...
                                        <ul className='p-0'>
                                            <li>
                                                <h5 className='m-0 option-link'>WEITERLESEN</h5>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-12 mt-2">
                                        <div className='about-product'>
                                            <ul className='p-0'>
                                                <li>
                                                    <h5 className='option-link'>BESTELLEN</h5>
                                                </li>
                                            </ul>
