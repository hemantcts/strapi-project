                            ...
                            <div className='btn_block justify-content-center'>
                                {bannerData?.links1.map((link, index) => (
                                    <div className={`buttn_${index + 1}`} key={index}>
                                        <MyLink className="button blue_btn text-uppercase m-3" link={link.link_url} text={link.link_text} />
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="heart_block">
                            ...
                            <div className="content_wrap">
                                ...
                                <div className='btn_block'>
                                    <MyLink className="button blue_btn text-uppercase" link='/' text={heartData?.left_side?.link?.link_text} />
                                </div>
                            </div>
                        </div>
                    </div>
