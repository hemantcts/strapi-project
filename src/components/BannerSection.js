        ...
        <>
            {!teamBanner ?
                ...
                (<section className={`wi_full py_3 banner_sec inner_banner ${color}`} style={{ background: `url('https://medzentrum.entwicklung-loewenmut.ch${bannerData?.Banner_Bild?.url}')` }}>
                   <img className='mobile_bnr_img' src={`https://medzentrum.entwicklung-loewenmut.ch${bannerData?.Banner_Bild?.url}`} />
                    {bannerData ? (
                    ...
                    <section className={`wi_full py_3 banner_sec inner_banner team_banner ${color}`}>
                        <img className='team_bnr_img visible_desktop' src={`https://medzentrum.entwicklung-loewenmut.ch${bannerData?.Banner_Bild?.url}`} />
                        <img className='team_bnr_img visible_mobile' src={`https://medzentrum.entwicklung-loewenmut.ch${bannerData?.Mobile_Banner_Bild?.url}`} />
                        {bannerData ? (
                            <div className="container-xxl">
                                <div className="row">
                                    <div className="col-12">
